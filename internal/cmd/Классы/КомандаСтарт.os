...
Процедура ОписаниеКоманды(Команда) Экспорт
	...
	Команда.Опция("P Path", "", "Путь к проекту")
		.ТСтрока();

	Команда.Опция("s src", "", "Путь к исходникам")
		.ТСтрока();
...
Процедура ВыполнитьКоманду(Знач Команда) Экспорт
	...
	ИдентификаторПроцесса = МенеджерПокрытия.ЗапуститьСборПокрытия(ИмяФайла, ПутьКПроекту, ПутьКИсходникам);
