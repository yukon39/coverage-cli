...
Функция НеНайденМодульУправляемогоПриложения()
	...
	|en='Managed application module not found for configuration with ID ""%1""'");
КонецФункции

Функция НеНайденМодульСеанса()
	Возврат НСтр("ru='Не найден модуль сеанса для конфигурации с идентификатором ""%1""';
	|en='Not found module session for configuration with ID ""%1""'");
КонецФункции
...
Функция НеНайденМодульВнешнегоСоединения()
	...
	|en='External connections module not found for configuration with ID ""%1""'");
КонецФункции
...
Функция НеНайденМодульОбычногоПриложения()
	...
	|en='Ordinary application module not found for configuration with ID ""%1""'");
КонецФункции

Функция НеНайденОбщийМодуль()
	Возврат НСтр("ru='Не найден общий модуль с идентификатором ""%1""';
	|en='Not found common module with ID ""%1""'");
КонецФункции
...
Функция НеНайденМодульМенеджераЗначения()
	...
	|en='Not found manager values module for object with ID ""%1""'");
КонецФункции
