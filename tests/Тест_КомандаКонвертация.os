...
Функция ПолучитьСписокТестов(Знач Тестирование) Экспорт
	...
	ИменаТестов.Добавить("ТестДолжен_КонвертироватьXML_PFF");
	ИменаТестов.Добавить("ТестДолжен_КонвертироватьEDT_PFF");
	ИменаТестов.Добавить("ТестДолжен_КонвертироватьКонфигурациюXML_PFF");
	ИменаТестов.Добавить("ТестДолжен_КонвертироватьКонфигурациюEDT_PFF");
	ИменаТестов.Добавить("ТестДолжен_КонвертироватьРасширениеXML_PFF");
	ИменаТестов.Добавить("ТестДолжен_КонвертироватьРасширениеEDT_PFF");
	ИменаТестов.Добавить("ТестДолжен_КонвертироватьВнешнийМодульXML_PFF");
	ИменаТестов.Добавить("ТестДолжен_КонвертироватьВнешнийМодульEDT_PFF");
	Возврат ИменаТестов;
...
Процедура ТестДолжен_КонвертироватьXML_XML() Экспорт
	...
	ДобавитьАргументInput(Аргументы, ФайлПокрытияCSV());
...
Процедура ТестДолжен_КонвертироватьXML_PFF() Экспорт
	...
	Аргументы = Новый Массив;
	ДобавитьАргументInput(Аргументы, ФайлПокрытияPFF());
	ДобавитьАргументOutput(Аргументы, ИмяФайлаРезультатов);
	ДобавитьАргументWorkspace(Аргументы, КаталогТестовыхДанных());
	ДобавитьАргументSources(Аргументы, КаталогИсходниковКонфигурацииXML());
	ДобавитьАргументFormat(Аргументы, "XML");
...
Функция ФайлПокрытияPFF()
	Возврат ОбъединитьПути(КаталогТестовыхДанных(), "coverage.pff");
КонецФункции
